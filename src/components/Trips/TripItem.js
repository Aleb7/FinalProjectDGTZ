            ...
            <div className=' my-2 rounded'>
                <Card text='black'>
                    ...
                    <Card.Body>
                        ...
                        <Card.Title className=' text-center'>{trips.name}</Card.Title>
                        <Card.Text>{trips.description}</Card.Text>
                        <Link className="btn btn-outline-info btn-sm" to={"trip/" + trips.id}>Scopri di più</Link>
                    </Card.Body>
                </Card>
                <div className=' col-12'>
